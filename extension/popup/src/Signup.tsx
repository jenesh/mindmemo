...
const Signup = () => {
  ...
  const handleLinkClick = () => {
    window.open('https://mindmemo-auth.vercel.app/', '_blank');
  };
          ...
          <div className="flex flex-col space-y-10 items-center justify-center py-12">
            ...
            <div className="flex flex-col items-center justify-center  w-full space-y-4">
              <div className="flex items-center justify-center bg-white px-6 py-2 rounded-full w-5/6 hover:bg-slate-100 transition-all">
                <button className="flex items-center justify-center space-x-3" onClick={handleLinkClick}>
                  <svg
                    width="17"
                    height="16"
                    viewBox="0 0 17 16"
              ...
              <div className="flex items-center justify-center space-x-2">
                <button className="font-Inter font-normal text-sm">Already have an account?</button>
                <button className="font-Inter font-normal text-sm" onClick={handleLinkClick}>
                  Sign in
                </button>
              </div>
            </div>
