...
const Days = ({ calendarData, onClickPreviousDays, onClickDay, onClickNextDays }) => {
  // Contexts
  const { primaryColor, period, changePeriod, dayHover, changeDayHover, minDate, maxDate, disabledDates } =
  ...
  const currentDateClass = useCallback(
    (item) => {
      ...
      if (formatDate(require$$0()) === formatDate(require$$0(itemDate))) return TEXT_COLOR['500'][primaryColor];
      return '';
    },
    ...
    (day) => {
      ...
      if (require$$0(fullDay).isSame(period.start) && require$$0(fullDay).isSame(period.end)) {
        ...
        className = ` ${BG_COLOR['500'][primaryColor]} text-white font-medium ${
          require$$0(fullDay).isSame(dayHover) && !period.end ? 'rounded-full' : 'rounded-l-full'
        }`;
      } else if (require$$0(fullDay).isSame(period.end)) {
        className = ` ${BG_COLOR['500'][primaryColor]} text-white font-medium ${
          require$$0(fullDay).isSame(dayHover) && !period.start ? 'rounded-full' : 'rounded-r-full'
        }`;
      }
      return {
...
const Calendar = ({ date, minDate, maxDate, onClickPrevious, onClickNext, changeMonth, changeYear }) => {
    ...
    (day, month = date.month() + 1, year = date.year()) => {
      ...
      if ((!period.start && !period.end) || (period.start && period.end)) {
        ...
        if (period.start && !period.end) {
          ...
          // End not null
          const condition =
            require$$0(fullDay).isSame(require$$0(period.end)) || require$$0(fullDay).isBefore(require$$0(period.end));
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      showMonths &&
        React.createElement(Months, { currentMonth: calendarData.date.month() + 1, clickMonth: clickMonth }),
      showYears &&
  ...
  const handleInputChange = useCallback(
    (e) => {
      ...
      if (dates[0]) {
        ...
        if (dates[1]) changeDayHover(require$$0(dates[1]).add(-1, 'day').format(DATE_FORMAT));
  ...
  !(function (e, _) {
    ...
    var t = _(e),
      d = {
        ...
        monthsShort:
          'كانون الثاني_شباط_آذار_نيسان_أيار_حزيران_تموز_آب_أيلول_تشرين الأول_ تشرين الثاني_كانون الأول'.split('_'),
...
(function (module, exports) {
  !(function (e, a) {
    ...
    var t = a(e),
      s = 'siječnja_veljače_ožujka_travnja_svibnja_lipnja_srpnja_kolovoza_rujna_listopada_studenoga_prosinca'.split(
        '_',
      ),
...
(function (module, exports) {
  !(function (e, s) {
    ...
    var i = s(e),
      d = 'sausio_vasario_kovo_balandžio_gegužės_birželio_liepos_rugpjūčio_rugsėjo_spalio_lapkričio_gruodžio'.split(
        '_',
      ),
...
(function (module, exports) {
  !(function (e, t) {
    ...
    var r = 'stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia'.split(
        '_',
      ),
...
(function (module, exports) {
  !(function (a, e) {
    ...
    var t = e(a),
      u = {
        name: 'rn',
        weekdays: 'Ku wa Mungu_Ku wa Mbere_Ku wa Kabiri_Ku wa Gatatu_Ku wa Kane_Ku wa Gatanu_Ku wa Gatandatu'.split(
          '_',
        ),
